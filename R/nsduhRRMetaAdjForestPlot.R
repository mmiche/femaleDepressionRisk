...
plotRRAdjForest <-
    ggplot(fpDfRR, aes(x=est, y=model)) + geom_point(shape=124, size=5) +
...
# ggsave(filename="plotRRAdjForest.png", plot = plotRRAdjForest, path = ggsavePath, device = "png", width=8, height=7, units="in", dpi=300)
