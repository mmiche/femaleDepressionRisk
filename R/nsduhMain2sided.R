...
# ---------------------------------------
#
# Run the analyses, use separate R script 'runRR_RD.R'
# Collect results in these three lists:
collectRiskResLs <- list()
...
for(r in 1:nrow(runRiskDf)) {
    ...
    source(paste0(nsduhPath, "runRR_RD2sided.R"), echo = FALSE)
...
#         file=paste0(nsduhPath, "collectRiskRes2SidedLs.rds"))
# # =========================